...
db.restaurantes.find({ name: { $regex: /^Wil/i } }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1 })
...
db.restaurantes.find({ name: { $regex: /ces$/i } }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1 })
...
db.restaurantes.find({ name: { $regex: /Reg/i } }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1 })
...
db.restaurantes.find({ borough: { $nin: ["Staten Island", "Queens", "Bronx", "Brooklyn"] } }, { restaurant_id: 1, name: 1, borough: 1, cusine: 1 })
...
db.restaurantes.find({ "grades.score": { $lt: 10 } }, { restaurant_id: 1, name: 1, borough: 1, cusine: 1 })
...
db.restaurantes.find({ cuisine: "Seafood", $nor: [{ cuisine: { nin: ["American", "Chinese"] } }, { name: { $regex: /^Wil/i } }] }, { restaurant_id: 1, name: 1, borough: 1, cusine: 1 })
...
db.restaurantes.find({ $and: [{ grades: { $elemMatch: { grade: "A" } } }, { grades: { $elemMatch: { score: 11 } } }, { grades: { $elemMatch: { date: ISODate("2014-08-11T00:00:00Z") } } }] }, { restaurant_id: 1, name: 1, grades: 1 })
...
db.restaurantes.find({ "grades.1": { $elemMatch: { grade: "A", score: 9, date: ISODate("2014-08-11T00:00:00Z") } } }, { restaurant_id: 1, name: 1, grades: 1 })
...
db.restaurantes.find({ "address.coord.1": { $gte: 42, $lte: 52 } }, { restaurant_id: 1, name: 1, address: 1 })
...
db.restaurantes.find({ grades: { $elemMatch: { score: { $mod: [7, 0] } } } }, { restaurant_id: 1, name: 1, grades: 1 })
...
db.restaurantes.find({ name: { $regex: /mon/i } }, { name: 1, borough: 1, "address.coord": 1, cuisine: 1 })
...
db.restaurantes.find({ name: { $regex: /^Mad/i } }, { name: 1, borough: 1, "address.coord": 1, cuisine: 1 })